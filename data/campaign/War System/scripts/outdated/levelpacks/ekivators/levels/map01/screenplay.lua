...
function level.screenplay.DoorRepairerCall()
	...
	pushcmd(function()
		func.NPC.SetAim("tech", 55, 18, true, {on_enter="func.NPC.SetAim('tech', 30, 18, true, {on_enter='level.screenplay.techIsNearDoor=true'})"})
	end, 2.5)
	pushcmd(function()
...
function level.screenplay.Attack(n)
	...
	elseif n == "boss_setbomb1" then
		...
		if level.screenplay.techIsNearDoor and exists("tech") then
			pushcmd(function()
